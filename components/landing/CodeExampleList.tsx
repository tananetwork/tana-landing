...
interface CodeExampleListProps {
  onExampleSelect: (example: CodeExample) => void
  selectedExample: CodeExample | null
}

export function CodeExampleList({ onExampleSelect, selectedExample }: CodeExampleListProps) {
      ...
      <div className="relative">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
          {codeExamples.map((example) => (
            <Card
              key={example.id}
              className={`min-w-80 bg-slate-900/50 border-blue-400/20 backdrop-blur-sm hover:border-blue-400/40 transition-all duration-300 cursor-pointer ${
